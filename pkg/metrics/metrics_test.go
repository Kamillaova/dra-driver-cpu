...
func TestDescriptors(t *testing.T) {
	...
	labelled := map[string][]string{
		...
		"dra_cpu_slice_handoffs_total":                  {"outcome"},
...
func TestNoopRecorder(t *testing.T) {
	...
	require.NotPanics(t, func() {
		...
		recorder.RecordSliceHandoff(HandoffAccepted)
...
func TestPromiseAndSliceMetrics(t *testing.T) {
	...
	m.RecordSliceHandoff(HandoffAccepted)
	m.RecordSliceHandoff(HandoffRefused)
	...
	require.InDelta(t, 1, testutil.ToFloat64(m.sliceHandoffs.WithLabelValues(HandoffAccepted)), 0.01)
	require.InDelta(t, 1, testutil.ToFloat64(m.sliceHandoffs.WithLabelValues(HandoffRefused)), 0.01)
