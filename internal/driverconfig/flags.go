...
func (c *Config) AddFlags(fs *flag.FlagSet) {
	...
	fs.StringVar(&c.BindAddress, "bind-address", c.BindAddress, "The address to bind the HTTP server for the /healthz and /metrics endpoints, and for /placements where driverConfig servePlacements is set")
