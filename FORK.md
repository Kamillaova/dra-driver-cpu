...
- `internal/driverconfig`: the `Defrag*`, `SharedPoolCPUs` and `PublishFitAnnotation` fields, their
  defaults and `validateDefrag`; the `Profiles` map, `Profile`, `ProfileLabel` and `WithProfile`
