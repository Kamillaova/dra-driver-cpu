...
- `pkg/store/cpu_allocation.go`: `Role`, `RoleExclusive`, `RoleShared`, `RequestAllocation`, `UnionOf`,
  ...
  `BeginSwap`, `CommitSwap`, `AbortSwap`, `checkSwapInFlight`, `sortedUIDs`, `GetRebindOrigin`,
  `GetResourceClaimAllocationUnion`, `GetResourceClaimOriginUnion`, `ClaimRecord`, `GetClaimRecord`,
