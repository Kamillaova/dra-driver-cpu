...
Which cores to give up is a decision about the fleet, not about the driver: every core in `reserved`
and in a pool is one no claim can ever use, and every uncore cache one of them touches is a cache no
whole-cache claim can ever have.
