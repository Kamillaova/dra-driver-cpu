...
const (
	...
	// not, with no promise that it will be made whole; a relocatable claim may
	// still be moved. This is the plain exclusive request.
...
type ClaimPlacementStatus struct {
	...
	// UncoreCaches lists the uncore (L3) cache IDs of the CPUs in CPUSet.
	UncoreCaches []int `json:"uncoreCaches,omitempty"`
